...
- validity checks on inputs are now added to all functions using either
  is(spe, “SpatialExperiment”) or is(m, “matrix”) etc.

#### vignette

- Explanation of plots and algorithm inside different functions are now
  added to the vignette briefly.
...
- the equation and theory of the calcMetrics are now added in the help
  page.
